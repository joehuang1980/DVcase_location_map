...
git init
git config --local user.name "joehuang1980"
git config --local user.email "joehuang1980@gmail.com"
...
git init && git config --local user.name "joehuang1980" && git config --local user.email "joehuang1980@gmail.com"
